...
- Body-text translation must be authored by the agent from the source and context; machine-translation libraries, translation APIs, local translation models, and browser page translation must not be used as draft sources.
...
6. Edit agent-authored translation drafts in `src/target-draft-md/`, or maintain `src/target-xhtml/` directly; do not batch-generate body-text drafts with MT tools.
